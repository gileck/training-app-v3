...
**Docs:** [docs/template/architecture.md](docs/template/architecture.md)
...
**Summary:** Runs both TypeScript and ESLint checks, shows ALL errors at once. Must pass with 0 errors before committing, creating PRs, or deploying.
...
**Summary:** Exit code 0 = Success, non-zero = Failure. Use try/catch with execSync.
...
**Commands:** `yarn sync-template`, `yarn sync-template --dry-run`

**Docs:** [docs/template/template-sync/template-sync.md](docs/template/template-sync/template-sync.md), [docs/template/template-sync/sync-flows-reference.md](docs/template/template-sync/sync-flows-reference.md)
...
**Commands:** `yarn sync-children`, `yarn push-sync`
...
**Summary:** Auto-detects `owner/repo` from git remote. Use `--cloud-proxy` in Claude Code cloud.

**Commands:** `yarn github-pr create`, `yarn github-pr list`, `yarn github-pr merge`
...
**Commands:** `yarn init-agents-copy`, `yarn github-workflows-agent --all`, `yarn verify-setup`

**Docs:** [docs/template/github-agents-workflow/](docs/template/github-agents-workflow/), [docs/template/init-github-projects-workflow.md](docs/template/init-github-projects-workflow.md)
...
**Summary:** Run `vercel link` first. **CRITICAL: Never use `npx vercel env add` with piped input** - use `yarn vercel-cli env:sync` instead.

**Commands:** `yarn vercel-cli list`, `yarn vercel-cli env:sync`, `yarn vercel-cli logs`
...
**Rules:** [.ai/skills/template/ai-models-api-usage/SKILL.md](.ai/skills/template/ai-models-api-usage/SKILL.md)
...
**Rules:** [.ai/skills/template/eslint-custom-guidelines/SKILL.md](.ai/skills/template/eslint-custom-guidelines/SKILL.md)
...
**Rules:** [.ai/skills/template/feature-based-structure/SKILL.md](.ai/skills/template/feature-based-structure/SKILL.md)
...
**Rules:** [.ai/skills/template/react-hook-organization/SKILL.md](.ai/skills/template/react-hook-organization/SKILL.md)
...
**Rules:** [.ai/skills/template/settings-usage-guidelines/SKILL.md](.ai/skills/template/settings-usage-guidelines/SKILL.md)
...
**Rules:** [.ai/skills/template/user-access/SKILL.md](.ai/skills/template/user-access/SKILL.md)
