...
import type { DraftPlan } from '@/apis/project/training-plans/types';
import type { PlanCreationSource } from '@/server/database/collections/project/trainingPlans/types';
