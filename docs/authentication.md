...
- **Long-lived tokens (10 years)**: Designed for PWA/mobile-like experience where users expect to stay logged in. Security is maintained via HttpOnly cookies and server-side validation.
